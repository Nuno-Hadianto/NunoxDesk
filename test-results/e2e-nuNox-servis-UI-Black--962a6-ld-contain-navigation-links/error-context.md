...
- Name: e2e.spec.js >> nuNox_servis UI Black-box testing >> Sidebar should contain navigation links
- Location: __tests__\e2e.spec.js:33:3
...
Call log:
  ...
  - waiting for locator('.sidebar')
    14 × locator resolved to <aside class="sidebar">…</aside>
       - unexpected value "hidden"

```

```yaml
- heading "nuNox Servis" [level=2]
- text: Username
- textbox "Masukkan username"
- text: Password
- textbox "Masukkan password"
- button "Masuk"
- paragraph: "Default admin: admin / admin123"
```
