...
- Name: e2e.spec.js >> nuNox_servis UI Black-box testing >> Clicking Pelanggan menu should switch to Customer View
- Location: __tests__\e2e.spec.js:44:3
...
Call log:
  - waiting for locator('#nav-customers')
    - locator resolved to <a href="#" id="nav-customers">Pelanggan</a>
